...
# Locked after ladder A/B on M3 Ultra (see LIVE.md): 384 TR-off sustains continuous
# Live; full 448 is the jacokon-matched sharp preset when headroom allows.
PRESETS: dict[str, QualityPreset] = {
    ...
    "live": QualityPreset(
        ...
        frames=LIVE_FRAMES,
        note="default — sharper DiT/VAE canvas, no token-reduction",
    ),
    "sharp": QualityPreset(
        name="sharp",
